...
public class Task3Test {
    ...
    enum IntegerSum implements StackManipulation {
        ...
        public Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            ...
            int indexPrev2Sum = 5;
            methodVisitor.visitLocalVariable("prev2Sum", "J", null, start, finish, indexPrev2Sum);
            ...
            methodVisitor.visitInsn(Opcodes.LCONST_1);
            methodVisitor.visitVarInsn(Opcodes.LSTORE, indexPrev2Sum);
            methodVisitor.visitInsn(Opcodes.LCONST_0);
            ...
            methodVisitor.visitVarInsn(Opcodes.LLOAD, indexPrev2Sum);
